...
export const projects: Project[] = [
  ...
  },
  {
    name: "SkillSwap",
    description:
      "A skill-bartering platform where people exchange what they can teach for what they want to learn — profile-based matching plus built-in messaging and scheduling to coordinate swaps.",
